...
namespace MauiUserApp.Views
{
    public partial class UserLoginPageViewModel : ObservableObject
    {
        ...
        private readonly ILogger<UserLoginPageViewModel> _logger;
        ...
        public UserLoginPageViewModel(ILogger<UserLoginPageViewModel> logger)
        {
        ...
        private async Task LoginAsync()
        {
            ...
            {
                IsBusy = true;
                var loginRequestUser = new LoginRequestUser
                {
                    Email = Email,
                    Password = Password
                };
                ...
                var response = await _httpClient.PostAsJsonAsync("/authenticate-user", loginRequestUser);
